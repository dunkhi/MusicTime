...
namespace MusicTime.Web.Models
{
  ...
  public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
  {
    ...
    public static void InitializeIdentityForEF(ApplicationDbContext db)
    {
      ...
      const string customerName = "customer@example.com";
      const string password2 = "Admin@123456";
      ...
      var user2 = userManager.FindByName(customerName);
      if (user2 == null)
      {
        user2 = new ApplicationUser { UserName = customerName, Email = customerName };
        var result = userManager.Create(user2, password2);
        result = userManager.SetLockoutEnabled(user2.Id, false);
      }

      var rolesForCustomer = userManager.GetRoles(user2.Id);
      if (!rolesForCustomer.Contains(role2.Name))
      {
